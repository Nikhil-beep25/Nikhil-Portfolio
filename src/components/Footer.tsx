...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    { icon: <FaInstagram size={16} />, url: INSTAGRAM_URL, label: "Instagram", color: "hover:text-[#EC4899] hover:shadow-[0_0_15px_rgba(236,72,153,0.4)] hover:border-[#EC4899]/30", ariaLabel: "Visit Nikhil Bhadauriya's Instagram Profile" },
